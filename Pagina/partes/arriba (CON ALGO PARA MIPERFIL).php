<?php
			...
			?>
				<form method="post" action="logeo.php">
					...
					<input type="submit" class="botonregistro" onclick="return loginvacio()" value="Logueate!">
				</form>
			...
			?>
				<h3>Sesión Actual</h3>
				<a href="miperfil.php" style="text-decoration:none"><p>Usuario: <?php echo $_SESSION['usuario'] ?></p></a>
