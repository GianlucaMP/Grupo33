...
3) links donde sea pertinente para facil accesibilidad


4) campo de eliminado de vehiculos. puede que halla quedado alguna pagina que no lo tenga en cuenta
...
1) en que consisten exactamente las HU nuevas que surgieron? link a detalle del viaje y listar pasajeros aceptados

2) si al borrar un vehiculo pierdo su informacion para datos viejos. NO deberia manetenerlo en la BD, y marcarlo de borrado como para que NO se muestre en nuevos viajes, pero que se guarden sus datos para los viejos.. O podemos reemplazar todo eso por un vehiculo eliminado


2) pensamos en la DB a partir de ahora mantener 2 tablas, viajes y viajes finalizados. La idea es obvia, los viajes que ya se les paso la fecha, irlos mandando a la otra tabla
...
a) altarespuestapostulacion. las querys de update 

b) al subir una postulacion, testearque se envie el estado 'P'

c) al aceptar rechazar una postulacion cargar el estado A o R

d) (revisar un poco mas todo lo de postulacion en general
