	...
	<h2>Mi perfil</h2>
		...
		<div id='datos'>
			...
			while ($listarpostulados=mysqli_fetch_array($postulados)) {  
					...
					echo'</div>';
					echo '<div>';
					echo '<a style="color: white; text-decoration:none; color: lightgreen" href="postulados.php?id='.$listarpostulados['id'].'"> Aceptar </a>';
					echo '<a style="color: white; text-decoration:none; color: red" href="postulados.php?id='.$listarpostulados['id'].'"> Rechazar </a>';
					echo '</div>';
					echo '</div>';
